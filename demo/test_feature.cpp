...
int main(int argc, char **argv) {
  ...
  // std::string camera_config_path = "/workspace//catkin_ws/src/AirVIO/configs/camera/euroc.yaml";
  // std::string dataroot = "/media/data/datasets/euroc/seq/MH_01_easy/";
  // std::string model_dir = "/workspace//catkin_ws/src/AirVIO/output";
  // std::string save_root = "/workspace//catkin_ws/src/AirVIO/debug/point_detection";

  std::string camera_config_path = "/workspace/catkin_ws/src/AirSLAM/configs/camera/tartanair.yaml";
  std::string dataroot = "/workspace/catkin_ws/src/AirSLAM/V1_02_medium/mav0";
  std::string model_dir = "/workspace/catkin_ws/src/AirSLAM/output";
  std::string save_root = "/workspace/catkin_ws/src/AirSLAM/debug/line_detection";
  ...
  for(size_t i = 0; i < dataset_length && ros::ok(); ++i){
    ...
    image_path = "//workspace/catkin_ws/src/AirSLAM/V1_02_medium/mav0/cam0/data/1403715523912143104.png";
    ...
    std::cout << image_left_rect.size() << std::endl;
